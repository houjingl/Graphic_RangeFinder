...
export PATH := /cygdrive/d/Quartus_Prime_Standard_23.1/quartus/bin64/:$(PATH)
export PATH := /cygdrive/d/Quartus_Prime_Standard_23.1/quartus/sopc_builder/bin/:$(PATH)

export PATH := D:/Quartus_Prime_Standard_23.1/quartus/bin64/:$(PATH)
export PATH := D:/Quartus_Prime_Standard_23.1/quartus/sopc_builder/bin/:$(PATH)
export PATH := D:/Quartus_Prime_Standard_23.1/riscfree/debugger/gdbserver-riscv/:$(PATH)
export PATH := D:/Quartus_Prime_Standard_23.1/riscfree/toolchain/riscv32-unknown-elf/bin/:$(PATH)
...
# Files
SYS_FILE_SOF			:= "D:/Quartus_Prime_Standard_23.1/fpgacademy/Computer_Systems/DE1-SoC/DE1-SoC_Computer/niosVg/DE1_SoC_Computer.sof"
SYS_SCRIPT_JTAG_ID		:= --script="D:/Quartus_Prime_Standard_23.1/fpgacademy/AMP/bin/jtag_instance_check.tcl"
SYS_FILE_ARM_PL			:= --preloader "D:/Quartus_Prime_Standard_23.1/fpgacademy/AMP/arm_tools/u-boot-spl.de1-soc.srec"
